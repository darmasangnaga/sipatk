    ...
    <section class="content">
      ...
      <div class="row">
	   ...
	   <!-- small box -->
          <div class="small-box bg-red">
            <div class="inner">
              <p><font size="5px"><b>Data Komputer</b></font></p>
              <p><a href="https://www.wieistmeineip.de/cometo/?en"><img src="https://www.wieistmeineip.de/ip-address/?size=468x60" border="0" width="330" height="60" alt="IP" /></a></p>
            </div>
            <div class="icon">
              <i class="ion ion-stats-bars"></i>
            </div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
			         <p>1. Struktural menginput data permintaan barang di form permintaan barang.</p>
            <p>2. Struktural permintaan di konfirmasi oleh Bendahara.</p>
            <p>3. Setelah di konfirmasi, kemudian Struktural mencetak Bukti Permintaan Barang dan kemudian membawa Bukti yang telah di sah kan oleh Kepala Sekolah Dan Ke Admin Bagian Pengadaan untuk dilakukan proses pengeluaran barang.</p>
				</div>
				<!-- footer modal -->
